...
-- Run this on a completely clean database
-- This creates: users, lists, links, saved_lists + all features
...
-- Saved lists table (many-to-many relationship)
...
CREATE INDEX idx_lists_public_id ON lists(public_id);
...
-- Success message
SELECT 
  '🎉 Complete schema created successfully!' as result,
