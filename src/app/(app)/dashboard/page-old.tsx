          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="px-4 py-2 text-sm font-semibold text-muted-foreground hover:text-foreground transition-colors bg-secondary"
              >
                Profile
              </Link>
              <Link
          ...
          <div className="max-w-[624px] mx-auto">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-6 py-2 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed"
              >
    ...
    <div>
      {lists.length === 0 ? (
        <div className="text-center py-16">
          <div className="w-24 h-24 bg-secondary flex items-center justify-center text-4xl mx-auto mb-6">
            🥨
          </div>
          ...
          <button
            ...
            disabled={creatingList}
            className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground hover:bg-primary/90 transition-colors font-semibold disabled:opacity-50 disabled:cursor-not-allowed text-lg"
  ...
  return (
    <div className="bg-card border border-border p-6">
      <div className="flex items-center gap-3 mb-3">
        <div className="p-2 bg-secondary text-muted-foreground">
          {icon}
        </div>
...
function ListCard({ list, showActions = true, onDelete }: ListCardProps) {
  ...
  return (
    <div className="relative bg-card p-6 hover:shadow-lg transition-all duration-200 group border border-border">
      {/* Action Buttons */}
      {showActions && (
